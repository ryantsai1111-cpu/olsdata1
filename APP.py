...
try:
    ...
    with tab4:
        ...
        # 整合了報告內所有極端波動與重大節點的完整事件資料
        events_data = [
            {
                "日期": "2020-03-12", 
                "事件名稱": "COVID-19「黑色星期四」流動性危機", 
                "受影響幣種": "USDT, USDC", 
                "波動方向": "溢價 (上漲)",
                "說明": "全球資本市場因疫情恐慌暴跌（比特幣單日跌 37.17%）。衍生品市場面臨連環強平，投資人瘋狂買入 USDT 與 USDC 避險。因傳統匯款延遲與區塊鏈擁堵，導致套利機制短暫失效，USDT 變動率異常高達 +5.48%。"
            },
            {
                "日期": "2022-05-09", 
                "事件名稱": "Terra (UST) 演算法穩定幣死亡螺旋", 
                "受影響幣種": "USDT, USDC", 
                "波動方向": "USDT 恐慌拋售 / USDC 資金流入",
                "說明": "UST 崩潰引發對所有穩定幣儲備真實性的恐慌。USDT 因持有商業票據等資產，遭遇數十億美元擠兌贖回；同時間資金轉向被認為更安全（由現金與美債支持）的 USDC，造成板塊內資金輪動。"
            },
            {
                "日期": "2023-03-11", 
                "事件名稱": "矽谷銀行 (SVB) 倒閉反噬", 
                "受影響幣種": "USDC, DAI", 
                "波動方向": "嚴重脫鉤 (下跌)",
                "說明": "Circle 宣布 33 億美元儲備金卡在破產的 SVB 中。因週末電匯關閉無法贖回，USDC 在二級市場暴跌至 $0.87。DAI 因儲備中包含大量 USDC，遭受「DeFi 嵌套風險」牽連而嚴重脫鉤。"
            },
            {
                "日期": "2024-09-01", 
                "事件名稱": "MakerDAO 升級為 Sky Protocol (USDS)", 
                "受影響幣種": "USDS", 
                "波動方向": "市佔率擴張",
                "說明": "DAI 正式重塑為 USDS，引入跨鏈能力與原生收益（Sky Savings Rate）分配機制，將國庫券收益分給用戶，在聯準會高息環境下吸引了大量資本。"
            },
            {
                "日期": "2025-10-10", 
                "事件名稱": "Ethena (USDe) 極端波動壓力測試", 
                "受影響幣種": "USDe", 
                "波動方向": "CEX 極端折價 / DEX 維持穩定",
                "說明": "宏觀地緣政治引發加密市場崩盤。依賴 Delta 中性對沖的 USDe，因中心化交易所 (Binance) 預言機與流動性枯竭短暫暴跌至 $0.65，但去中心化交易所 (DEX) 仍堅守 $0.99 附近，展現了流動性隔離效應。"
            },
            {
                "日期": "2025-11-15", 
                "事件名稱": "PYUSD 於 DeFi 生態爆發性增長", 
                "受影響幣種": "PYUSD", 
                "波動方向": "供應量激增",
                "說明": "PayPal 發力去中心化金融領域，PYUSD 在以太坊上的供應量於短短一週內激增 6.25 億美元，迅速躍升為 DeFi 生態系中第六大穩定幣。"
            },
            {
                "日期": "2026-01-10", 
                "事件名稱": "傳統股權市場與 Sky (USDS) 深度綁定", 
                "受影響幣種": "USDS", 
                "波動方向": "資本結構升級",
                "說明": "納斯達克上市公司 NovaBay 更名為 Stablecoin Development Corp (SDEV)，並持有高達 21.5 億枚 SKY 代幣（佔總供應量 9.15%），標誌著傳統金融與 USDS 協議的深度整合。"
            },
            {
                "日期": "2026-03-17", 
                "事件名稱": "PayPal (PYUSD) 全球佈局擴展", 
                "受影響幣種": "PYUSD", 
                "波動方向": "全球採用率增長",
                "說明": "PYUSD 將使用權限擴展至全球 70 個市場。透過大幅優化跨國清算週期，將穩定幣的應用場景從「加密資產交易媒介」推進為「全球商業結算基礎設施」。"
            }
        ]
        ...
        st.markdown("根據分析報告，我們可以將穩定幣的波動歸納為以下三種底層傳導邏輯：")
        ...
        with col2:
            ...
            st.write("如 USDC 在 2023 年 SVB 倒閉事件。法幣抵押型穩定幣（包含 USDC、PYUSD）高度依賴傳統銀行的託管安全。一旦託管銀行破產或傳統匯款網路關閉，即會引發毀滅性的恐慌拋售。")
        with col3:
            st.success("**3. DeFi 嵌套與預言機失效**")
            st.write("如 DAI 在 SVB 事件被牽連，以及 USDe 在 2025 年因中心化交易所定價失常而閃崩。依賴智能合約和衍生品市場的穩定幣，其風險通常來自演算法連鎖反應或數據源提供錯誤。")
